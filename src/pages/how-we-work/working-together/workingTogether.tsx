          ...
          <div className="working-together__body">
            <div className="working-together__body-wrapper">
              ...
              <TextDescription subtype="mb">
                ...
                misconceptions about applying two of those, and explain how we
                at Blackbird exactly utilizing them.
              </TextDescription>
            </div>
            <TextImage large="large" image={People} typeValue="lighter" />
          </div>
          <span className="working-together__text">
            The comparison is broken down into these important topics for your
            comfort:
          </span>
          ...
          <div className="working-together__text-body">
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                However, you have all the controls on you, so the team
                recommends alternative but, eventually, does what you tell.
              </TextDescription>
            </div>
            <div className="working-together__text-wrapper">
              <SectionTitle
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                issues or emergencies. Any goal you set or an outcome you seek
                will be accomplished. Period.
              </TextDescription>
            </div>
          </div>
        </div>
          ...
          <div className="working-together__text-body">
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                with people we have and add the requested talents in less than
                3–4 weeks. No delays ever
              </TextDescription>
              <RecomendedText
                title="On You"
                textPoints={[
          ...
          <div className="working-together__text-body">
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                about security and your intellectual property. For instance, as
                one of the steps of our onboarding framework, we make sure that
                all the sensual information handoff is conducted via both your
                and our security policies. More info on intellectual property
                protection is down the page.
              </TextDescription>
            </div>
            <div className="working-together__text-wrapper">
              <SectionTitle
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                when you will definitely enjoy our full service. Not only we
                assist your in-house team in the process of hand-off, but we
                also provide them with well-outlined doable tasks to relieve
                stress and to bring clarity. As well as to cut transferred
                project assets into actionable work-ready pieces. Even if months
                of in-house work is required to do a complete handoff, we are
                always able to move your project forward with a small stack of
                starter assets.
              </TextDescription>
            </div>
          </div>
        ...
        <div className="working-together__body">
          <div className="working-together__body-wrapper">
            ...
            <TextDescription subtype="mb">
              ...
              do not appreciate stretching a project for longer than it really
              needs to be successfully done.
            </TextDescription>
          </div>
          <TextImage
            typeValue="lighter"
          ...
          <div className="working-together__text-body">
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                candidate to adopt the ownership mentality. Regardless of the
                above scenarios, you’ll have a great talent pool to ramp-up
                human resources quickly.
              </TextDescription>
              <RecomendedText
                title="On You"
                textPoints={[
            ...
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                IT problems, product development, and support. HR duties, any
        ...
        <div className="working-together__body">
          <div className="working-together__body-wrapper">
            ...
            <TextDescription subtype="mb">
              ...
              your off-site employees or a dedicated team with a project
        ...
        <div className="working-together__body">
          <div className="working-together__body-wrapper">
            ...
            <TextDescription subtype="mb">
              ...
              Blackbird engineers are required to attend an annual security
              training designed specifically for engineers. Read more on our
          ...
          <div className="working-together__text-body">
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                members, we will replace them at no extras until you are 100%
                happy.
              </TextDescription>
            </div>
            <div className="working-together__text-wrapper">
              ...
              <TextDescription type="dark" subtype="mb">
                ...
                and maintain your product, etc. All the essentials like code
                environments, essential software, and hardware are on us.
              </TextDescription>
            </div>
          </div>
        </div>
