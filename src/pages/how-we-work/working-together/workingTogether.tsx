                ...
                <div className="working-together__img">
                    <div className="working-together__body">
                        <div className="working-together__body-wrapper">
                            ...
                            <TextDescription>
                                Regardless, of the hiring model you choose, we will always make sure
                                you are aware of all possibilities and potential pitfalls in advance
                                of making your final decision.
                            </TextDescription>
                        </div>
                        {/* <TextImage
                            id="responsibility"
