    ...
    <Layouts>
      ...
      <section className="what-we-do">
        ...
        <div className="what-we-do__description">
          ...
          <TextDescription>
            Our clients’ products are heavily used by such companies like
            Walmart, The Home Depot, CVS Pharmacy in the USA and Canada. It’s a
            joy to be a part of their success.
          </TextDescription>
        </div>
        ...
        <div className="what-we-do__description">
          ...
          <TextDescription>
            The construction industry is well-known to us: from creating a fully
            custom ERP system for a large general engineering contractor to
            working on a pioneering AR-based product for both HoloLens versions
            and its web dashboard.
          </TextDescription>
        </div>
        <div className="what-we-do__companies">
          <div className="what-we-do__company">
        ...
        <div className="what-we-do__description-wrapper" id="what-we-do">
          <div className="what-we-do__description">
            ...
            <TextDescription>
              It took a few years of close-up work with large U.S. general
              engineering contractor to investigate, analyze, optimize their
              internal processes, and finally built an ERP system which put them
          ...
          <div className="what-we-do__description">
            ...
            <TextDescription>
              ...
              proprietary software products for internal marketing teams. We did
              it all.
            </TextDescription>
          </div>
        </div>
        ...
        <TextDescription>
          Only market-tested services are listed below. Nevertheless, we are
          always open to challenge ourselves. It is inbred part of our R&D DNA.
        </TextDescription>
      </section>
      <section className="what-we-do">
