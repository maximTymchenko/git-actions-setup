...
const PageHeader: FC = (props: IPageHeader) => {
    return (
        <div data-testid="page-header" className="page-header">
            <div className={`page-header__wrapper page-header__wrapper--${props.bgType}`}>
                <div className="page-header__container">
                    <div className="page-header__img-left" />
                    <div className="page-header__title">
                        <h2 className="title title--small">{props.subtitle}</h2>
                        <h1 className="title title--section title--brackets">{props.title}</h1>
                    </div>
                    <div className="page-header__img-right" />
                </div>
                <div
                    className={`page-header__button-wrapper page-header__button-wrapper--${props.btnPosition}`}
                >
